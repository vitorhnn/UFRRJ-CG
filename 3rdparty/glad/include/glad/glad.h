/*
    ...
    OpenGL loader generated by glad 0.1.18a0 on Sat Apr 21 20:07:46 2018. (at some weird time that's making my make go nuts -- Victor)
    ...
    Commandline:
        --profile="compatibility" --api="gl=3.3" --generator="c" --spec="gl" --no-loader --extensions="GL_ARB_debug_output"
    Online:
        http://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&api=gl%3D3.3&extensions=GL_ARB_debug_output
*/
